...
languages <- c("Semai_expressive",
               ...
               "Shona_ideophone",
               "Sesotho_ideophone",
               "Kota (India)_onomatopoetics",
               "Vietnamese_impressif",
               "Khasi_phonaesthetic words",
               "Pacoh_ideophone",
               "South Azerbaijani_onomatopes",
...
write_csv(df, "terminology_map.csv", na = "NA")
```
